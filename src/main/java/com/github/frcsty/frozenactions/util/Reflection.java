...
public final class Reflection {
    ...
    private static final String[] VERSION_COMPONENTS = Bukkit.getServer().getClass().getPackage().getName().split("\\.");
    static final String VERSION = VERSION_COMPONENTS.length >= 4 ? VERSION_COMPONENTS[3] : "Not 1.8 Woohoo!";
