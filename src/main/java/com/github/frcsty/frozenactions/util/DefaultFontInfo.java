...
public enum DefaultFontInfo {
    ...
    public static @NotNull DefaultFontInfo getDefaultFontInfo(final @NotNull Character character) {
        for (final DefaultFontInfo info : values()) {
            if (info.character == character) return info;
        }
